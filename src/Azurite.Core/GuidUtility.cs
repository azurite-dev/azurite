...
namespace Azurite
{
	...
	public static class GuidUtility
	{
		...
		public static Guid Create(string name) => Create(ShipNamespace, name, 5);
		...
		/// </summary>
		public static readonly Guid ShipNamespace = new Guid("929a328b-c56b-4fd8-a135-261d183d3c6e");
